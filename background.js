    ...
    ipcMain.handle("blockchainRequest", async (event, arg) => {
        ...
        if (methods.includes("verifyAccount")) {
            ...
            try {
                ...
                console.log(error);
                responses["verifyAccount"] = { error: error };
            }
        ...
        if (methods.includes("verifyCloudAccount")) {
            ...
            try {
                ...
                console.log(error);
                responses["verifyCloudAccount"] = { error: "Failed to derive authorities" };
            }
            ...
            if (authorities) {
                ...
                try {
                    ...
                    console.log(error);
                    responses["verifyCloudAccount"] = { error: error || "Failed to verify account" };
                }
